...
async def pars_scoda(message: Message):
    ...
    shkoda = []
    if os.path.exists("Шкода.json"):

        with open ("Шкода.json", "r", encoding="utf-8") as file:
    ...
    with open ("Шкода.json", "w", encoding="utf-8") as file:
...
async def search_yellow(message: Message):
    ...
    with open("Mac Yellow.json", "w", encoding="utf-8") as file:
...
async def search_touch(message: Message):
    ...
    with open ("Mac_touch.json", "w", encoding="utf-8") as file:
